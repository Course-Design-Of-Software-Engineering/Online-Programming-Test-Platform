						...
						<el-row>
							...
							<el-col span="12">
								...
								<el-form :model="intervieweeInfo" ref="intervieweeInfo" label-width="95px"
									...
									<el-form-item label="用户名" prop="user"
										...
										<el-input placeholder="请输入密码" v-model="intervieweeInfo.user">
										</el-input>
									</el-form-item>
									<!-- 密码 -->
									...
									<el-form-item label="确认密码" prop="checkPassword"
										...
										<el-input placeholder="请再次输入确认密码" show-password>
										</el-input>
									</el-form-item>
								</el-form>
							</el-col>
							<el-col span="12">
								...
								<el-form :model="intervieweeInfo" ref="intervieweeInfo" label-width="95px"
									class="demo-ruleForm">
									<!--意向 -->
									<el-form-item label="意向" prop="goal">
									...
									<!--目前岗位-->
									<el-form-item label="目前岗位" prop="goal">
										<el-input placeholder="请输入你的目前岗位" type="text"
											v-model="intervieweeInfo.currPosition" autocomplete="off">
										</el-input>
									</el-form-item>
								</el-form>
							</el-col>
							...
							<el-col span="12">
								...
								<el-form :model="intervieweeInfo" ref="intervieweeInfo" label-width="95px"
									...
									<el-form-item label="激活码" prop="key"
										...
										<el-input placeholder="请输入激活码" v-model="intervieweeInfo.key">
										</el-input>
									</el-form-item>
									<!--手机号 -->
									<el-form-item label="手机号码" prop="phone">
